...
function IcRoundBookmarkBorder(props) {
    return (
        <svg width="1.5em" height="1.5em" viewBox="0 0 24 24" {...props}><path fill="currentColor" d="M17 3H7c-1.1 0-2 .9-2 2v16l7-3l7 3V5c0-1.1-.9-2-2-2zm0 15l-5-2.18L7 18V6c0-.55.45-1 1-1h8c.55 0 1 .45 1 1v12z"></path></svg>
    )
}


function IcRoundBookmark(props) {
    return (
        <svg width="1.5em" height="1.5em" viewBox="0 0 24 24" {...props}><path fill="currentColor" d="M17 3H7c-1.1 0-2 .9-2 2v16l7-3l7 3V5c0-1.1-.9-2-2-2z"></path></svg>
    )
}

export { IcRoundFavoriteBorder, IcRoundFavorite, IcRoundComment, IcRoundAccountCircle, IcRoundBookmarkBorder, IcRoundBookmark }